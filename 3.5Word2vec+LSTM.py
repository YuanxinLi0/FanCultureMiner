...
def create_word2vec_sequences(tokenized_texts, labels):
    ...
    model = Word2Vec(sentences=filtered_texts, vector_size=100, window=50, min_count=2, workers=4, sg=1, epochs=50)
